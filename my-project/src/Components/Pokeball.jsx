    ...
    return(<section className='h-full'> 
               ...
               {transition((style, item) => item ? <animated.div style={style} className="h-2/4 bg-red-500 w-full flex justify-center items-center relative">
                ...
                {transition3((style, item) => item ? "":        
                    ...
                    <div style={style} className={`h-full w-full ${bgColor} absolute -z-20 flex sm:items-start md:items-center justify-start grid grid-cols-8 md:overflow-x-hidden sm:overflow-auto`}>
